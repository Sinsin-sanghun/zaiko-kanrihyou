/**
 * AI Chatbot Widget - zaiko-kanrihyou
...
(function () {
  ...
  /* ── Config ── */
  const API = "/api/chat";
  const TITLE = "\u{1F4E6} AI\u5728\u5EAB\u30A2\u30B7\u30B9\u30BF\u30F3\u30C8";
  const PLACEHOLDER = "AI\u306B\u8CEA\u554F\uFF08\u4F8B: \u5728\u5EAB\u5207\u308C\u306E\u90E8\u54C1\u306F\uFF1F \u767A\u6CE8\u72B6\u6CC1\u306F\uFF1F\uFF09";
  ...
  style.textContent = `
    ...
    .ai-chat-bar input:focus{border-color:#f97316;}
    .ai-chat-bar input::placeholder{color:#94a3b8;}
    .ai-chat-bar button{padding:10px 20px;border-radius:8px;border:none;
      background:#ea580c;color:#fff;font-size:14px;cursor:pointer;white-space:nowrap;}
    .ai-chat-bar button:hover{background:#c2410c;}
    ...
    .ai-panel-body .ai-msg.assistant h3{color:#f97316;font-size:14px;margin:12px 0 4px;}
    ...
    .ai-panel-body .ai-msg.assistant strong{color:#fdba74;}
